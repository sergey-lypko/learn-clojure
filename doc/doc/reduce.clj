...
; на след. итерации функция f получает на вход результат ^ (первым аргументом) и 3й э-т последовательности и тд.
; если opt-initial-val было передано, в первой итерации функция f начнет действие над ним и 1м э-м последовательности
